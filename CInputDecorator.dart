...
import 'package:flutterdemo/utility/RColors.dart';


const Duration _kTransitionDuration = Duration(milliseconds: 200);
const Curve _kTransitionCurve = Curves.fastOutSlowIn;

// Defines the gap in the CInputDecorator's outline border where the
...
// An analog of CInputDecoration for the _Decorator widget.
class _Decoration {
  const _Decoration({
...
class _RenderDecoration extends RenderBox {
  ...
  _RenderDecorationLayout _layout(BoxConstraints layoutConstraints) {
    ...
    'An CInputDecorator, which is typically created by a TextField, cannot '
        'have an unbounded width.\n'
        'This happens when the parent widget does not provide a finite width '
        'constraint. For example, if the CInputDecorator is contained by a Row, '
        'then its width must be constrained. An Expanded widget or a SizedBox '
        'can be used to constrain the width of the CInputDecorator or the '
    ...
    // Layout all the widgets used by CInputDecorator
...
class CInputDecorator extends StatefulWidget {
  ...
  ///
  /// If null, `const CInputDecoration()` is used. Null [InputDecoration]
  /// properties are initialized with the corresponding values from
  /// [ThemeData.inputDecorationTheme].
  final CInputDecoration decoration;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
        DiagnosticsProperty<CInputDecoration>('decoration', decoration));
...
class _InputDecoratorState extends State<CInputDecorator>
    with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    final bool labelIsInitiallyFloating = widget.decoration
  ...
  CInputDecoration _effectiveDecoration;

  CInputDecoration get decoration {
  ...
  @override
  void didUpdateWidget(CInputDecorator old) {
    super.didUpdateWidget(old);
    if (widget.decoration != old.decoration)
      _effectiveDecoration = null;

    final bool floatBehaviourChanged = widget.decoration
        .floatingLabelBehavior != old.decoration.floatingLabelBehavior
        // ignore: deprecated_member_use_from_same_package
        || widget.decoration.hasFloatingPlaceholder !=
            old.decoration.hasFloatingPlaceholder;

    if (widget._labelShouldWithdraw != old._labelShouldWithdraw ||
        floatBehaviourChanged) {
  ...
  TextStyle _getFloatingLabelStyle(ThemeData themeData) {
    ...
    final TextStyle style = themeData.textTheme.subtitle1.merge(
        widget.baseStyle);
    return style
      ...
      child: AnimatedOpacity(
        ...
        child: AnimatedDefaultTextStyle(
          ...
          style: widget._labelShouldWithdraw
              ...
              : inlineLabelStyle,
          child: decoration.isMandate != null && decoration.isMandate
              ? RichText(
            overflow: TextOverflow.ellipsis,
            textAlign: textAlign,
            text: TextSpan(
              ...
              style: DefaultTextStyle
                  ...
                  .style,
              children: <TextSpan>[
                TextSpan(text: '*', style: TextStyle(color: RColors.red)),
//                TextSpan(text: ' world!'),
              ],
            ),
          )
...
/// Widget build(BuildContext context) {
///   return TextField(
///     decoration: CInputDecoration.collapsed(
///       hintText: 'Hint Text',
...
///     initialValue: 'abc',
///     decoration: const CInputDecoration(
///       prefix: Text('Prefix'),
///       suffix: Text('Suffix'),
///       border: OutlineInputBorder(),
///     ),
...
class CInputDecoration {
  ...
  const CInputDecoration.collapsed({
  ...
  /// configured by the CInputDecorator, depending on the values of
  ...
  /// If null, CInputDecorator's default is `const UnderlineInputBorder()`.
  ///
  /// See also:
  ///
  ///  * [InputBorder.none], which doesn't draw a border.
  ...
  CInputDecoration applyDefaults(InputDecorationTheme theme) {
    return copyWith(
  ...
  bool operator ==(Object other) {
    ...
    if (other.runtimeType != runtimeType)
      return false;
    return other is CInputDecoration
        && other.icon == icon
        && other.labelText == labelText
        && other.isMandate == isMandate
  ...
  String toString() {
    final List<String> description = <String>[
      ...
      if (isMandate != null) 'isMandate: "$isMandate"',
      ...
      if (floatingLabelBehavior !=
          null) 'floatingLabelBehavior: $floatingLabelBehavior',
      ...
      if (prefixIconConstraints !=
          null) 'prefixIconConstraints: $prefixIconConstraints',
      ...
      if (suffixIconConstraints !=
          null) 'suffixIconConstraints: $suffixIconConstraints',
...
@immutable
class CInputDecorationTheme with Diagnosticable {
  ...
  bool operator ==(Object other) {
    ...
    if (other.runtimeType != runtimeType)
      return false;
    return other is CInputDecorationTheme
        && other.labelStyle == labelStyle
        && other.helperStyle == helperStyle
        && other.helperMaxLines == helperMaxLines
        && other.hintStyle == hintStyle
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    const CInputDecorationTheme defaultTheme = CInputDecorationTheme();
    properties.add(DiagnosticsProperty<TextStyle>(
